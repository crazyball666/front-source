  ...
  */
  ...
  Image.prototype = {
    ...
    _createEditPanel: function _createEditPanel() {
      ...
      // id
      var imgW = getRandom('img-width');
      var imgH = getRandom('img-height');
      var maxW = getRandom('img-max-width');
      var maxH = getRandom('img-max-height');
      var W30 = getRandom('img-W30');
      var W50 = getRandom('img-W50');
      var W80 = getRandom('img-W80');
      var W100 = getRandom('img-W100');
      var reset = getRandom('reset-btn');
      ...
      var tabsConfig = [{
        ...
        <div style="font-size:14px">\n
          <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n
            ...
            <br/>
            <span>宽: </span><input id="${imgW}" placeholder="width" value="${imageStyle.width}" />\n
            <br/>
            <span>高: </span><input id="${imgH}" placeholder="height" value="${imageStyle.height}" />\n
            <br/>
            <span>最大宽: </span><input id="${maxW}" placeholder="max width" value="${imageStyle.maxWidth}" />\n
            <br/>
            <span>最大高: </span><input id="${maxH}" placeholder="max height" value="${imageStyle.maxHeight}" />\n
          </div>\n
          <div class="w-e-button-container">\n
            <button id="${W30}" class="gray">30%</button>
            <button id="${W50}" class="gray">50%</button>
            <button id="${W80}" class="gray">80%</button>
            <button id="${W100}" class="gray">100%</button>
            <button id="${reset}" class="gray">重置</button>\n
          </dv>\n
        </div>`,
        events: [{
          selector: '#' + imgW,
          ...
          fn: function fn() {
            ...
            querySelectorAll("#" + imgW)[0].value = "30%"
            querySelectorAll("#" + imgH)[0].value = "auto"
            // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
            return false;
          }
        }, {
          ...
          fn: function fn() {
            ...
            querySelectorAll("#" + imgW)[0].value = "50%"
            querySelectorAll("#" + imgH)[0].value = "auto"
            // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
            return false;
          }
          ...
          fn: function fn() {
            ...
            querySelectorAll("#" + imgW)[0].value = "80%"
            querySelectorAll("#" + imgH)[0].value = "auto"
            // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
            return false;
          }
          ...
          fn: function fn() {
            ...
            querySelectorAll("#" + imgW)[0].value = "100%"
            querySelectorAll("#" + imgH)[0].value = "auto"
            // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
            return false;
          }
          ...
          fn: function fn() {
            ...
            querySelectorAll("#" + imgW)[0].value = ""
            querySelectorAll("#" + imgH)[0].value = ""
            querySelectorAll("#" + maxW)[0].value = ""
            querySelectorAll("#" + maxH)[0].value = ""
            // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
            return false;
          }
        }]
  ...
  Editor.prototype = {
    ...
    _initDom: function _initDom() {
      ...
      if (textSelector == null) {
        ...
        $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('flex', '1').css("overflow-y", "auto");
      } else {
